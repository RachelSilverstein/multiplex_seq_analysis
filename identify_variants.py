...
main_dir = "."
MAX_INSERTION_FREQ = 0.2  # call a variant an insertion when frequency of reads with insertions above this fraction
...
# specifically for reference sequence pCAG-hSpCas9-NLS-FLAG-P2A-EGFP_MSP2582_extraction.fasta
mutated_positions = [3507, 3508, 3509, 3510, 3511, 3512, 3756, 3757, 3758, 3759, 3760, 3761, 4101, 4102, 4103, 4107, 4108, 4109, 4113, 4114, 4115]
recoded_positions = {4106: "G", 4112: "T"}
